...
if (isset($_POST['bttReg'])){
    ...
    if (mysqli_num_rows($result2)==1 ){
        ...
        $result1 = mysql_query($con, 'insert into users (userID, name, email, country, developer, admin, privID, username, password) values("U007", "'.$fullname.'", "'.$email.'","'.$country.'","1","", "PR01", "'.$username1.'", "'.$password1.'")');
